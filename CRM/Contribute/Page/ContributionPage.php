...
class CRM_Contribute_Page_ContributionPage extends CRM_Core_Page {
    ...
    public function &onlineContributionLinks() {
        if (!isset(self::$_onlineContributionLinks)) {
            ...
            $installmentsUrlParams1 = 'reset=1&action=update&id=7';
            $installmentsUrlParams2 = 'reset=1&action=update&id=8';
            ...
            self::$_onlineContributionLinks = array(
                ...
                CRM_Core_Action::INSTALLMENT => array(
                    'name' => ts('First Installment Page'),
                    'title' => ts('First Installment Page'),
                    'url' => $urlString,
                    'qs' => $installmentsUrlParams1,
                    'fe' => TRUE,
                    'uniqueName' => 'installment_page',
                ),
                CRM_Core_Action::INSTALLMENT_N => array(
                    'name' => ts('N Installment Page'),
                    'title' => ts('N Installment Page'),
                    'url' => $urlString,
                    'qs' => $installmentsUrlParams2,
                    'fe' => TRUE,
                    'uniqueName' => 'installment_n_page',
                ),
